...
# Avoid possible circular dependency with our platform-res
ariel_plat_res_package_export := \
    $(call intermediates-dir-for,APPS,com.arielos.platform-res,,COMMON)/package-export.apk

lineage_plat_res_package_export_deps := \
    $(dir $(lineage_plat_res_package_export))src/R.stamp

ariel_plat_res_package_export_deps := \
    $(dir $(ariel_plat_res_package_export))src/R.stamp
